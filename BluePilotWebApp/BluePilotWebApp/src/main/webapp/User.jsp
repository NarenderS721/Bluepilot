	...
	<section>
		<div class="row">
			<div class="col-sm-5 p-4  ">
				<h4 class="bg-light text-center p-2">User LOGIN</h4>
			...
			<div class="col-sm-5 p-4  ">
				<h4 class="bg-light text-center p-2">User Registration</h4>
				<form action="UserRegister" method="post" class="form-group"
					...
					<div class="form-group m-2">
						...
						<input type="number" name="age"  max="120" min="18"
							class="form-control" placeholder="User Age" required />
					</div>
					<div class="form-group m-2">
						<label>Gender:</label>
